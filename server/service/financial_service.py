...
from utilities import bank_account_decode, date_form_validation
...
def do_past_fin_transactions(customer_id, start_date, end_date):
    ...
    check_start = date_form_validation(start_date)
    check_end = date_form_validation(end_date)

    if check_start is True and check_end is True:
